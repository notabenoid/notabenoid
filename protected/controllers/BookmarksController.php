...
class BookmarksController extends Controller
{
    ...
    public function actionEdit()
    {
        ...
        if (!$bm) {
            throw new CHttpException(404, 'Закладки не существует. Возможно, она уже удалена.');
        }
    ...
    public function actionRemove()
    {
        $bm = $this->loadBookmark();
        if (!$bm) {
            throw new CHttpException(404, 'Закладки не существует. Вероятно, она уже удалена.');
        }
