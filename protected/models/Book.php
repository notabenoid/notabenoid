...
//	public $banned, $ban_until; /* OBSOLETE */
    ...
    protected function afterFind()
    {
        ...
        if ($this->facecontrol == self::FC_OPEN) {
    ...
    public function can($what)
    {
        ...
        if ($what == 'moderate') {
            return $this->membership->status == GroupMember::MODERATOR;
        }
        if ($what == 'dict_edit') {
            return $this->membership->status == GroupMember::MODERATOR;
        }
        ...
        if ($this->$ac == 'a') {
            if (Yii::app()->user->isGuest and !($what == 'read' || $what == 'trread' || $what == 'gen' || $what == 'blog_r')) {
                return false;
            } else {
                return true;
            }
        ...
        if ($this->$ac == 'g') {
            return $this->membership->status == GroupMember::MEMBER or $this->membership->status == GroupMember::MODERATOR;
        }
        if ($this->$ac == 'm') {
            return $this->membership->status == GroupMember::MODERATOR;
        }
