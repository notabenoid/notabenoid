...
class Notice extends CActiveRecord
{
    ...
    public function render()
    {
        ...
        if ($this->typ == self::INVITE) {
            ...
            return "За какие-то прегрешения модераторы или владелец перевода забанили вас в группе перевода <a href='/book/{$m[0]}'>{$m[1]}</a>. Вы больше не сможете войти в этот перевод до тех пор, пока они не отменят своего, возможно, опрометчивого решения.";
