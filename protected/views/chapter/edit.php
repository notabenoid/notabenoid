<?php
    /**
     * @var Chapter
     * @var int     - ID главы с особыми правами доступа в этом переводе; 0, если такой нет; -1, если это единственная глава в переводе
     * @var bool    - если редактор встраивается в другую страницу
     */
