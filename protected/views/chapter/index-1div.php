	...
	<?php
        ...
        if ($orig_dp->totalItemCount > $p->pageSize) {
            ...
            if ($p->currentPage + 1 == 1) {
                echo "<span class='pseudo'>&larr;</span>";
            } else {
            ...
            for ($i = 1; $i <= $p->pageCount; $i++) {
                ...
                if ($cur) {
                    echo "<input type='text' name='Orig_page' value='{$i}' placeholder='...' accesskey='g' />";
                } else {
            ...
            if ($p->currentPage + 1 >= $p->pageCount) {
                echo "<span class='pseudo'>&rarr;</span>";
            } else {
...
<?php
    ...
    if (!$chap->can('tr')) {
        $tableClasses[] = 'translator-te-hide';
    }
?>
