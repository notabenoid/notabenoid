...
<?php
    ...
    $s = [0 => 0, 1 => 0];
    foreach ($higgsStat as $uid => $iface) {
        $s[$iface]++;
    }
    $n = $s[0] + $s[1];
...
<svg xmlns="http://www.w3.org/2000/svg" version="1.1" id="graph">
	...
	<?php
        ...
        echo "<polyline stroke='rgb(0,200,0)' stroke-width='2' fill='none' points='".implode(' ', $coordsStay)."' />\n\n";
        echo "<polyline stroke='rgb(0,0,200)' stroke-width='2' fill='none' points='".implode(' ', $coordsLeft)."' />\n\n";
    ?>
</svg>
