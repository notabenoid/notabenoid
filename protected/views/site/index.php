    ...
    <div class="span7" id="f-hot">
        ...
        <div id="f-hot-ini" class="modal hide">
            ...
            <div class="modal-body" style="max-height:350px">
                ...
                <div class="control-group">
                    <div class="controls">
                        <label class="checkbox"><input type="hidden" name="img" value="0" /><input type="checkbox" name="img" value="1" <?php if (Yii::app()->user->ini['hot.img']) {
    echo 'checked';
} ?>/> с картинками</label>
                    </div>
                </div>
        ...
        <?php
            foreach ($blog as $post) {
                ...
                if ($post->n_comments > 0) {
                    echo " <span class='c'><i class='icon-nb-comment'></i> {$post->n_comments}</span>";
                }
                echo '</a>';
