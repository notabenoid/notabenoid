...
Самый простой способ запустить приложение — использовать Docker. Установите Docker с помощью вашего пакетного менеджера и выполните следующую команду (от root или от пользователя, включённого в группу docker):
