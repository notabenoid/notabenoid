var GLOBALS = {
    ac_areas: {
        ac_read: "войти",
        ac_trread: "читать переводы",
        ac_gen: "скачивать",
        ac_rate: "оценивать",
        ac_comment: "комментировать",
        ac_tr: "переводить",
        ac_blog_r: "читать блог",
        ac_blog_c: "комментировать в блоге",
        ac_blog_w: "писать посты в блоге",
        ac_announce: "создавать анонсы перевода",
        ac_membership: "управлять членством в группе перевода",
    ...
    ac_roles_title: {
        a: "все",
        g: "только члены группы перевода",
        m: "только модераторы",
        o: "только владелец"
    },
...
$(function() {
    $(".upic.active").click(function() {
        ...
        $("#userinfo_win").modal().on("hidden", function() {
            $(this).remove()
        });
        return false;
    ...
    $("[accesskey]").each(function() {
        ...
        var title = $this.attr("title"),
            text = ("Alt+") + $this.attr("accesskey").toUpperCase();
