    ...
    var methods = {
        init: function(options) {
            ...
            function rateClick(e) {
                ...
                var $this = $(this),
                    mark = $this.hasClass("n") ? -1 : 1,
                    id = methods._getId(this);
            ...
            function scrollDn(e) {
                ...
                $newCmt.each(function() {
                    var $this = $(this),
                        top = $this.offset().top;
                    if (top > st + wh) {
                        $.scrollTo(top + $this.height() - wh + 10, 100, {
                            onAfter: function() {
                                var bg = $this.css("background-color");
                                $this.animate({
                                    backgroundColor: "#BDBD8E"
            ...
            var $newCmt = $(".comment.new", opts.multiple ? undefined : this),
                newCmtCur = 0;
        ...
        _saveCookie: function() {
            $.cookie("ff_comments_c", collapsed.join(","), {
                expires: 365
            });
        },
