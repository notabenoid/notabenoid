$(function() {
    ...
    function commentsToggle(e) {
        ...
        function close(e) {
            ...
            if ($(this).is("button")) $("body").animate({
                scrollTop: scrollTop
            }, 200);
        }
    ...
    var tb = {
        init: function() {
            var $toolbar = $("#tb-main"),
                $sidebar = $("#tr-sidebar"),
                $filter = $("#tb-filter"),
                $filterBtn = $toolbar.find(".tb-filter"),
                trTop, trHeight,
                tbTop = $toolbar.offset().top,
                tbHeight = $toolbar.outerHeight(),
    ...
    var tr = {
        ...
        edit: function(e) {
            ...
            if (tr.id !== null) {
                if ((id == 0 && tr.id == 0 && tr.orig_id == orig_id) || (id != 0 && tr.id == id)) {
                    tr.cancel();
                    return;
                }
                tr.cancel();
        ...
        edit: function(e) {
            ...
            $td.addClass("loading").load(url, {}, function() {
                ...
                $ta.elastic()
                    ...
                    .keyup().focus();
                orig.timer = setInterval(function() {
                    $ta.keyup()
                }, 333);
    ...
    (function() {
        ...
        var explain = function(e) {
            ...
            $.ajax({
                ...
                dataType: "json",
                success: function(data) {
                    var d, html, $ulNeg = $votesBox.find(".list.neg ul"),
                        $ulPos = $votesBox.find(".list.pos ul");
                    for (var i in data) {
                        d = data[i];
    ...
    (function() {
        ...
        var $ul = $div.find("ul"),
            ...
            $blurLeft = $div.find(".blur.left"),
            $blurRight = $div.find(".blur.right");
