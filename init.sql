...
5	1	{1,5}	Комедии	t
6	1	{1,6}	Драмы	t
7	1	{1,7}	Фантастика	t
8	1	{1,8}	Боевики, приключения	t
9	1	{1,9}	Ужасы, триллеры	t
10	1	{1,10}	Детективы	t
11	1	{1,11}	Мелодрама	t
12	1	{1,12}	Мультфильмы	t
13	1	{1,13}	Документальные	t
14	1	{1,14}	Телепередачи	t
15	1	{1,15}	Мюзиклы	t
16	1	{1,16}	Прочее	t
17	2	{2,17}	Проза	t
18	2	{2,18}	Поэзия	t
19	2	{2,19}	Публицистика	t
20	2	{2,20}	Научно-техническая литература	t
21	2	{2,21}	Коллективное творчество	t
22	2	{2,22}	Комиксы	t
23	2	{2,23}	Прочее	t
24	3	{3,24}	Игры	t
25	3	{3,25}	Офисные	t
26	3	{3,26}	Компьютерная графика	t
27	3	{3,27}	Научные	t
28	3	{3,28}	Утилиты	t
29	3	{3,29}	Интернет	t
30	3	{3,30}	Прочее	t
31	4	{1,4,31}	Доктор Хаус	t
32	4	{1,4,32}	Косяки (Weeds)	t
33	4	{1,4,33}	Californication	t
34	4	{1,4,34}	Doctor Who	t
35	4	{1,4,35}	Теория большого взрыва (The Big Bang Theory)	t
36	4	{1,4,36}	Декстер (Dexter)	t
37	4	{1,4,37}	Сверхъестественное (Supernatural)	t
38	4	{1,4,38}	The Fades	t
39	4	{1,4,39}	Анатомия Грей (Grey's Anatomy)	t
40	12	{1,12,40}	Симпсоны	t
41	12	{1,12,41}	Футурама	t
42	12	{1,12,42}	American Dad	t
43	12	{1,12,43}	Family Guy	t
44	17	{2,17,44}	Классика	t
45	17	{2,17,45}	Фантастика	t
46	17	{2,17,46}	Для детей	t
47	17	{2,17,47}	Фэнтези	t
48	18	{2,18,48}	Песни	t
49	20	{2,20,49}	IT	t
50	20	{2,20,50}	Естественные науки	t
51	20	{2,20,51}	Точные науки	t
52	20	{2,20,52}	Гуманитарные науки	t
\.
...
SELECT pg_catalog.setval('catalog_id_seq', 53, false);
